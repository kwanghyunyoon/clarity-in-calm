...
**Outcome:** Implemented, tested, and verified; not yet committed — awaiting the user's go-ahead, and separately awaiting their decision on how to source the missing `ko`/`hi` overdose phrases.
