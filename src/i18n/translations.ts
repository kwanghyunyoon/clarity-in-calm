...
export const ko: Translations = {
  ...
  today: { title: '오늘', checkIn: '지금 기분이 어떠세요?', logEmotion: '감정 기록', streakDays: '일 연속', streakStart: '오늘 감정을 기록해 스트릭을 시작하세요', tools: '빠른 도구', breatheTitle: '박스 호흡', breatheSub: '4-4-4-4 · 신경계 안정', groundTitle: '5-4-3-2-1 그라운딩', groundSub: '현재 순간에 집중하기', todayEmotions: '오늘의 감정', noEmotionsYet: '오늘 아직 기록된 감정이 없어요', quote: '오늘의 명언' },
