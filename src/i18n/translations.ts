...
export const en = {
  ...
  contextTagLabels: {       // ← INSIDE emotionsScreen, BEFORE deleteConfirm
    work:         'Work',
    home:         'Home',
    family:       'Family',
    health:       'Health',
  ...
  settingsScreen: {
    ...
    account: {
      ...
      deviceLocal: 'Device-local. No account needed — everything stays encrypted on this device.',
...
emotionsScreen: {
  title: '감정',
  subtitle: '지금 어떤 감정인가요?',
  selectEmotion: '지금 느끼는 감정을 탭하세요',
  intensity: '강도',
  intensityLow: '약함',
  intensityHigh: '강함',
  contextTags: '지금 무슨 상황인가요?',
  bodyCheckIn: '어디서 느껴지나요?',
  copingActions: '어떻게 했나요?',
  note: '노트 추가 (선택사항)',
  notePlaceholder: '이 감정에 대한 생각…',
  saveBtn: '감정 기록하기',
  savedBtn: '✓ 저장됨!',
  pastTitle: '최근 감정',
  emptyTitle: '감정 기록이 여기 나타납니다',
  emptyBody: '위에서 감정을 탭해 첫 감정을 기록하세요',
  otherPill: '+ 기타',
  customPlaceholder: '느끼는 감정을 입력하세요…',
  quickLog: '빠른 기록',
  fullLog: '전체 기록',
  selectedEmotion: '선택됨',
  contextTagLabels: {
...
emotionsScreen: {
  title: 'Emociones',
  subtitle: '¿Qué estás sintiendo?',
  selectEmotion: 'Toca cómo te sientes',
  intensity: 'Intensidad',
  intensityLow: 'leve',
  intensityHigh: 'intensa',
  contextTags: '¿Qué está pasando?',
  bodyCheckIn: '¿Dónde lo sientes?',
  copingActions: '¿Qué hiciste?',
  note: 'Agrega una nota (opcional)',
  notePlaceholder: 'Tus pensamientos sobre este sentimiento…',
  saveBtn: 'Registrar emoción',
  savedBtn: '✓ ¡Registrado!',
  pastTitle: 'Emociones recientes',
  emptyTitle: 'Tus registros aparecerán aquí',
  emptyBody: 'Toca una emoción arriba para registrar la primera',
  otherPill: '+ Otro',
  customPlaceholder: 'Escribe cómo te sientes…',
  quickLog: 'Registro rápido',
  fullLog: 'Registro completo',
  selectedEmotion: 'Seleccionado',
  ...
  deleteConfirm: {
    ...
    body:    'Este registro se eliminará de forma permanente.',
    confirm: 'Eliminar',
    cancel:  'Cancelar',
  },
},
...
export const hi: Translations = {
  ...
  emotionsScreen: {
  title: 'भावनाएँ',
  subtitle: 'अभी क्या महसूस हो रहा है?',
  selectEmotion: 'अपनी भावना पर टैप करें',
  intensity: 'तीव्रता',
  intensityLow: 'हल्का',
  intensityHigh: 'तीव्र',
  contextTags: 'अभी क्या हो रहा है?',
  bodyCheckIn: 'कहाँ महसूस हो रहा है?',
  copingActions: 'आपने क्या किया?',
  note: 'नोट जोड़ें (वैकल्पिक)',
  notePlaceholder: 'इस भावना के बारे में विचार…',
  saveBtn: 'भावना दर्ज करें',
  savedBtn: '✓ दर्ज हो गया!',
  pastTitle: 'हाल की भावनाएँ',
  emptyTitle: 'आपकी भावनाएँ यहाँ दिखेंगी',
  emptyBody: 'पहली भावना दर्ज करने के लिए ऊपर टैप करें',
  otherPill: '+ अन्य',
  customPlaceholder: 'अपनी भावना लिखें…',
  quickLog: 'त्वरित लॉग',
  fullLog: 'पूर्ण लॉग',
  selectedEmotion: 'चुना गया',
  contextTagLabels: {
    work:         'काम',
    home:         'घर',
    family:       'परिवार',
