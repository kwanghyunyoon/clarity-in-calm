...
export const ko: Translations = {
  ...
  settingsScreen: { title: '설정', clarityUnlock: 'Clarity 잠금 해제', unlocked: '✓ 잠금 해제됨', unlockTitle: 'Clarity 전체 기능 열기', unlockPrice: '$4.99 · 일회 결제, 구독 없음', unlockFeatures: ['무제한 감정 카테고리', '무제한 기록 및 분석', '미래의 나에게 편지', '패턴 인사이트', '가이드 일기 템플릿'], unlockBtn: '$4.99로 잠금 해제', restoreBtn: '구매 복원', notifications: '매일 알림', notificationsOff: '끄기', notificationsOn: '켜기', reminderTime: '알림 시간', reminderDays: '요일', appearance: '외관', themeSystem: '시스템', themeLight: '밝은', themeDark: '어두운', language: '언어', data: '내 데이터', exportData: '전체 데이터 내보내기 (JSON)', deleteData: '전체 데이터 삭제', deleteConfirm: { title: '전체 데이터를 삭제할까요?', body: '모든 일기, 감정 기록, 설정이 영구적으로 삭제됩니다. 취소할 수 없어요.', confirm: '모두 삭제', cancel: '취소' }, privacy: '개인정보 처리방침', version: '버전', daysShort: ['일', '월', '화', '수', '목', '금', '토'], about: '앱 정보', aboutBody: 'Clarity in Calm은 오프라인 우선 웰니스 앱입니다. 모든 데이터는 기기에 암호화되어 저장됩니다.' },
